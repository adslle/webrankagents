...
public class ServiceUser {
    ...
    public ServiceUser(String wsdlUrl, String serviceName) throws Throwable{
            ...
            for(int i=0; i<names.length; i++){
            	System.out.println(names[i].getLocalPart());
    ...
    public static void main(String[] args) throws Throwable {
        String sn = "Hotel_IbisService";
        String url = "http://192.168.99.1:1302/Hotel_Ibis?wsdl";
        ...
        for (int l=2; l<ops.length; l++){
            ...
            ArrayList<String[]> callMethod = su.callMethod(params, new long[1], new int[1]);
